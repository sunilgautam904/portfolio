...
const Projects = () => {
  return (
    <div id="projects" className="w-full pt-4 px-4">
      <h1 className="md:text-4xl sm:text-3xl text-2xl text-black font-bold my-4 text-center py-6">
        Projects
      </h1>
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8 mt-8">
        <div className="w-full shadow-xl bg-gradient-to-r from-[#f7f7f7] to-[#cdc5c5cc] border [] flex flex-col p-6 my-4 rounded-lg hover:scale-105 duration-300">
          <img
          ...
          <button className="bg-[#8B55B0] hover:bg-purple-700 text-white w-[200px] my-6 mx-auto px-6 py-3 rounded-md py-3 transition-all duration-300 ease-in-out transform hover:scale-105">
            Visit
          </button>
        </div>
        <div className="w-full shadow-xl bg-gradient-to-r from-[#f7f7f7] to-[#cdc5c5cc] border [] flex flex-col md:my-0 my-8 rounded-lg hover:scale-105 duration-300">
          <img
            className="w-20 h-20 mx-auto mt-[-3rem] bg-white rounded-full shadow-md"
